...
class App extends React.Component<AppProps, AppState> {
  ...
  render() {
    return (
      <div className="App">
        <Router>
        <header className="App-header"><Navbar fixed="top" bg="dark" variant="dark" expand="lg"><Navbar.Brand><MDBNavLink exact to="/"><img src={logo} alt="Logo" /></MDBNavLink></Navbar.Brand><MDBNavbarNav right>
        ...
        <MDBCollapse isOpen={this.state.collapse} navbar>
              ...
              <MDBNavItem>
                <MDBNavLink exact to="/about">About</MDBNavLink>
              </MDBNavItem>
